...
Config.TunningLocations = {
	{
		...
		coords = vec3(-221.51, -1329.91, 30.89), --The coords to open menu
		job = "arabes", --The job that have access to it (remove the line and everyone can access it)
...
Config.Chameleon = {
	{ id = 150, label = "Camaleón Verde" },
	{ id = 151, label = "Camaleón Morado" },
	-- ...add more if desired...
}

Config.Job = 'arabes' -- define the current workshop job
