...
$(document).on('click', ".menu-item", function() {
    ...
    if (type == "main-menu") {
        ...
        $.post('https://TunningSystem/action', JSON.stringify({
            action: "openSubMenu",
        ...
        var textoinput = `<label id="texto">Código Hex: </label>`;
        var testeinput = `<input id="hexInput" type="text" value="Código Hex"></input>`;
        $("#item-wrapper").append(newItemDiv);
...
$("#confirm").text("Sí");
$("#kinda").text("No, gracias");
$("#texto").text("Código Hex:");
